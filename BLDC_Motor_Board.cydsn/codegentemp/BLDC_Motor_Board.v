...
// Timer_v2_80(CaptureAlternatingFall=false, CaptureAlternatingRise=false, CaptureCount=2, CaptureCounterEnabled=false, CaptureInputEnabled=false, CaptureMode=0, CONTROL3=0, ControlRegRemoved=0, CtlModeReplacementString=SyncCtl, CyGetRegReplacementString=CY_GET_REG16, CySetRegReplacementString=CY_SET_REG16, DeviceFamily=PSoC4, EnableMode=0, FF16=false, FF8=false, FixedFunction=false, FixedFunctionUsed=0, HWCaptureCounterEnabled=false, InterruptOnCapture=false, InterruptOnFIFOFull=false, InterruptOnTC=false, IntOnCapture=0, IntOnFIFOFull=0, IntOnTC=0, NumberOfCaptures=1, param45=1, Period=319, RegDefReplacementString=reg16, RegSizeReplacementString=uint16, Resolution=16, RstStatusReplacementString=rstSts, RunMode=1, SiliconRevision=0, SoftwareCaptureModeEnabled=false, SoftwareTriggerModeEnabled=false, TriggerInputEnabled=true, TriggerMode=3, UDB16=true, UDB24=false, UDB32=false, UDB8=false, UDBControlReg=true, UsesHWEnable=0, VerilogSectionReplacementString=sT16, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=Timer_v2_80, CY_CONFIG_TITLE=Timer_Rotor_Delay, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=Timer_Rotor_Delay, CY_INSTANCE_SHORT_NAME=Timer_Rotor_Delay, CY_MAJOR_VERSION=2, CY_MINOR_VERSION=80, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.4, INSTANCE_NAME=Timer_Rotor_Delay, )
...
module top ;
	...
	wire [0:0] tmpOE__UH_net;
	wire [0:0] tmpFB_0__UH_net;
	wire [0:0] tmpIO_0__UH_net;
	wire [0:0] tmpINTERRUPT_0__UH_net;
	electrical [0:0] tmpSIOVREF__UH_net;

	cy_psoc3_pins_v1_10
		#(.id("aa84b704-2a7e-4630-b9c9-0a7dd437d181"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		UH
		 (.oe(tmpOE__UH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__UH_net[0:0]}),
		  .io({tmpIO_0__UH_net[0:0]}),
		  .siovref(tmpSIOVREF__UH_net),
		  .interrupt({tmpINTERRUPT_0__UH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__UL_net;
	wire [0:0] tmpFB_0__UL_net;
	wire [0:0] tmpIO_0__UL_net;
	wire [0:0] tmpINTERRUPT_0__UL_net;
	electrical [0:0] tmpSIOVREF__UL_net;

	cy_psoc3_pins_v1_10
		#(.id("edf4a43f-eb2a-4f52-9071-7e567174de26"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		UL
		 (.oe(tmpOE__UL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__UL_net[0:0]}),
		  .io({tmpIO_0__UL_net[0:0]}),
		  .siovref(tmpSIOVREF__UL_net),
		  .interrupt({tmpINTERRUPT_0__UL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__UL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VH_net;
	wire [0:0] tmpFB_0__VH_net;
	wire [0:0] tmpIO_0__VH_net;
	wire [0:0] tmpINTERRUPT_0__VH_net;
	electrical [0:0] tmpSIOVREF__VH_net;

	cy_psoc3_pins_v1_10
		#(.id("bd2cd623-23aa-455d-91e7-ade246dc06ff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		VH
		 (.oe(tmpOE__VH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VH_net[0:0]}),
		  .io({tmpIO_0__VH_net[0:0]}),
		  .siovref(tmpSIOVREF__VH_net),
		  .interrupt({tmpINTERRUPT_0__VH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__VL_net;
	wire [0:0] tmpFB_0__VL_net;
	wire [0:0] tmpIO_0__VL_net;
	wire [0:0] tmpINTERRUPT_0__VL_net;
	electrical [0:0] tmpSIOVREF__VL_net;

	cy_psoc3_pins_v1_10
		#(.id("22f62978-195d-41cc-bc16-6bfa3cac221b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		VL
		 (.oe(tmpOE__VL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VL_net[0:0]}),
		  .io({tmpIO_0__VL_net[0:0]}),
		  .siovref(tmpSIOVREF__VL_net),
		  .interrupt({tmpINTERRUPT_0__VL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__VL_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__WH_net;
	wire [0:0] tmpFB_0__WH_net;
	wire [0:0] tmpIO_0__WH_net;
	wire [0:0] tmpINTERRUPT_0__WH_net;
	electrical [0:0] tmpSIOVREF__WH_net;

	cy_psoc3_pins_v1_10
		#(.id("65db8fe1-d362-4ae6-9fd0-68da221e2e5a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		WH
		 (.oe(tmpOE__WH_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__WH_net[0:0]}),
		  .io({tmpIO_0__WH_net[0:0]}),
		  .siovref(tmpSIOVREF__WH_net),
		  .interrupt({tmpINTERRUPT_0__WH_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__WH_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__WL_net;
	wire [0:0] tmpFB_0__WL_net;
	wire [0:0] tmpIO_0__WL_net;
	wire [0:0] tmpINTERRUPT_0__WL_net;
	electrical [0:0] tmpSIOVREF__WL_net;

	cy_psoc3_pins_v1_10
		#(.id("4229c041-dedc-4641-a51e-3bcc95ea0b4e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		WL
		 (.oe(tmpOE__WL_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__WL_net[0:0]}),
		  .io({tmpIO_0__WL_net[0:0]}),
		  .siovref(tmpSIOVREF__WL_net),
		  .interrupt({tmpINTERRUPT_0__WL_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	cy_psoc3_pins_v1_10
		#(.id("20363a88-1aa9-4e15-a7fe-63eccd151423"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    SCB_P4_v4_0_2 Current_Sensor_I2C (
        .clock(1'b0),
        .cts_in(1'b0),
        .interrupt(Net_552),
        .m_miso(1'b0),
	...
	cy_psoc3_pins_v1_10
		#(.id("573b3b6a-d15c-476e-82e7-fe336c0a7ddc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
    ...
    defparam Debouncer.SignalWidth = 2;

    CyStatusReg_v1_90 Address_Register (
        .clock(Net_1496),
        .intr(Net_362),
        .status_0(Net_114),
        .status_1(1'b0),
        ...
        .status_7(1'b0),
        .status_bus(8'b0));
    defparam Address_Register.Bit0Mode = 0;
    defparam Address_Register.Bit1Mode = 0;
    defparam Address_Register.Bit2Mode = 0;
    defparam Address_Register.Bit3Mode = 0;
    defparam Address_Register.Bit4Mode = 0;
    defparam Address_Register.Bit5Mode = 0;
    defparam Address_Register.Bit6Mode = 0;
    defparam Address_Register.Bit7Mode = 0;
    defparam Address_Register.BusDisplay = 0;
    defparam Address_Register.Interrupt = 0;
    defparam Address_Register.MaskValue = 0;
    defparam Address_Register.NumInputs = 4;

	wire [0:0] tmpOE__DRV_EN_net;
	wire [0:0] tmpFB_0__DRV_EN_net;
	wire [0:0] tmpIO_0__DRV_EN_net;
	wire [0:0] tmpINTERRUPT_0__DRV_EN_net;
	electrical [0:0] tmpSIOVREF__DRV_EN_net;

	cy_psoc3_pins_v1_10
		#(.id("29938f8e-7989-4f38-afcc-a0b03c6eb22d"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		DRV_EN
		 (.oe(tmpOE__DRV_EN_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__DRV_EN_net[0:0]}),
		  .io({tmpIO_0__DRV_EN_net[0:0]}),
		  .siovref(tmpSIOVREF__DRV_EN_net),
		  .interrupt({tmpINTERRUPT_0__DRV_EN_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__DRV_EN_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    SCB_P4_v4_0_3 TMC6100_SPI (
        .clock(1'b0),
        .cts_in(1'b0),
        .interrupt(Net_574),
        .m_miso(1'b0),
	...
	cy_psoc3_pins_v1_10
		#(.id("1d31fa91-03b7-4d9d-8954-367aaf0290a1"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    Timer_v2_80_4 Timer_Rotor_Delay (
        .capture(1'b0),
        .capture_out(Net_1447),
        .clock(Net_1457),
        .enable(1'b1),
        .interrupt(Net_1455),
        .reset(Net_12),
        .tc(Net_1458),
        .trigger(Net_1460));
    defparam Timer_Rotor_Delay.CaptureCount = 2;
    defparam Timer_Rotor_Delay.CaptureCounterEnabled = 0;
    defparam Timer_Rotor_Delay.DeviceFamily = "PSoC4";
    defparam Timer_Rotor_Delay.InterruptOnCapture = 0;
    defparam Timer_Rotor_Delay.InterruptOnTC = 0;
    defparam Timer_Rotor_Delay.Resolution = 16;
    defparam Timer_Rotor_Delay.SiliconRevision = "0";
    ...
    assign Net_1364[0] = ~Net_1365;


    assign Net_1364[1] = ~Net_1363;
	...
	cy_psoc3_pins_v1_10
		#(.id("61a63c74-75bf-4771-9581-6086e70f6279"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("9180543e-4fe7-4df7-85a3-72ecdc712ad2"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d43474b0-8608-4f06-9f9a-1c0a20b03a8a"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Cur_Alert_1_net;
	wire [0:0] tmpFB_0__Cur_Alert_1_net;
	wire [0:0] tmpIO_0__Cur_Alert_1_net;
	wire [0:0] tmpINTERRUPT_0__Cur_Alert_1_net;
	electrical [0:0] tmpSIOVREF__Cur_Alert_1_net;

	cy_psoc3_pins_v1_10
		#(.id("86bed5a6-0673-4c7a-83e6-9a30b3987bd4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Cur_Alert_1
		 (.oe(tmpOE__Cur_Alert_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Cur_Alert_1_net[0:0]}),
		  .io({tmpIO_0__Cur_Alert_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Cur_Alert_1_net),
		  .interrupt({tmpINTERRUPT_0__Cur_Alert_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Cur_Alert_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Cur_Alert_2_net;
	wire [0:0] tmpFB_0__Cur_Alert_2_net;
	wire [0:0] tmpIO_0__Cur_Alert_2_net;
	wire [0:0] tmpINTERRUPT_0__Cur_Alert_2_net;
	electrical [0:0] tmpSIOVREF__Cur_Alert_2_net;

	cy_psoc3_pins_v1_10
		#(.id("cc3e9f6f-5caf-404a-8d6d-d4f281c09f03"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Cur_Alert_2
		 (.oe(tmpOE__Cur_Alert_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Cur_Alert_2_net[0:0]}),
		  .io({tmpIO_0__Cur_Alert_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Cur_Alert_2_net),
		  .interrupt({tmpINTERRUPT_0__Cur_Alert_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Cur_Alert_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Cur_Alert_3_net;
	wire [0:0] tmpFB_0__Cur_Alert_3_net;
	wire [0:0] tmpIO_0__Cur_Alert_3_net;
	wire [0:0] tmpINTERRUPT_0__Cur_Alert_3_net;
	electrical [0:0] tmpSIOVREF__Cur_Alert_3_net;

	cy_psoc3_pins_v1_10
		#(.id("2a6186b2-000b-49f2-9d1b-18ed09a8a15b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Cur_Alert_3
		 (.oe(tmpOE__Cur_Alert_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Cur_Alert_3_net[0:0]}),
		  .io({tmpIO_0__Cur_Alert_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Cur_Alert_3_net),
		  .interrupt({tmpINTERRUPT_0__Cur_Alert_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
    ...
    assign Net_1441 = Net_1438 ^ Net_1439;


    assign Net_1460 = Net_1441 ^ Net_1442;
    ...
    CyStatusReg_v1_90 Limit_Register (
        .clock(Net_1496),
        .intr(Net_883),
        .status_0(1'b0),
        .status_1(1'b0),
        ...
        .status_6(1'b0),
        .status_7(1'b0),
        .status_bus(Net_796[1:0]));
    defparam Limit_Register.Bit0Mode = 0;
    defparam Limit_Register.Bit1Mode = 0;
    defparam Limit_Register.Bit2Mode = 0;
    defparam Limit_Register.Bit3Mode = 0;
    defparam Limit_Register.Bit4Mode = 0;
    defparam Limit_Register.Bit5Mode = 0;
    defparam Limit_Register.Bit6Mode = 0;
    defparam Limit_Register.Bit7Mode = 0;
    defparam Limit_Register.BusDisplay = 1;
    defparam Limit_Register.Interrupt = 1;
    defparam Limit_Register.MaskValue = 3;
    defparam Limit_Register.NumInputs = 2;

    Timer_v2_80_5 Timer_Period_Reset (
        .capture(1'b0),
        .capture_out(Net_1593),
        .clock(Net_1496),
        .enable(1'b1),
        .interrupt(Net_1596),
        .reset(Net_1597),
        .tc(Net_1598),
        .trigger(1'b1));
    defparam Timer_Period_Reset.CaptureCount = 2;
    defparam Timer_Period_Reset.CaptureCounterEnabled = 0;
    defparam Timer_Period_Reset.DeviceFamily = "PSoC4";
    defparam Timer_Period_Reset.InterruptOnCapture = 0;
    defparam Timer_Period_Reset.InterruptOnTC = 1;
    defparam Timer_Period_Reset.Resolution = 8;
    defparam Timer_Period_Reset.SiliconRevision = "0";
