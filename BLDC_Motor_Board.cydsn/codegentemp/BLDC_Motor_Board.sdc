...
# Project: C:\Users\davis\Documents\PSoC Creator\BLDC_Motor_Board_PY2023\BLDC_Motor_Board.cydsn\BLDC_Motor_Board.cyprj
# Date: Sat, 13 Apr 2024 19:58:24 GMT
#set_units -time ns
create_clock -name {UART_SCBCLK(FFB)} -period 725 -waveform {0 362.5} [list [get_pins {ClockBlock/ff_div_2}]]
create_clock -name {TMC6100_SCBCLK(FFB)} -period 75 -waveform {0 37.5} [list [get_pins {ClockBlock/ff_div_3}]]
...
create_generated_clock -name {TMC6100_SCBCLK} -source [get_pins {ClockBlock/hfclk}] -edges {1 3 7} [list]
...
# Component constraints for C:\Users\davis\Documents\PSoC Creator\BLDC_Motor_Board_PY2023\BLDC_Motor_Board.cydsn\TopDesign\TopDesign.cysch
# Project: C:\Users\davis\Documents\PSoC Creator\BLDC_Motor_Board_PY2023\BLDC_Motor_Board.cydsn\BLDC_Motor_Board.cyprj
# Date: Sat, 13 Apr 2024 19:58:21 GMT
