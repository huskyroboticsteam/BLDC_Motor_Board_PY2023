...
# Date: Fri, 23 Feb 2024 22:18:11 GMT
#set_units -time ns
...
create_clock -name {ADC_Pot_intClock(FFB)} -period 1000 -waveform {0 500} [list [get_pins {ClockBlock/ff_div_10}]]
...
create_generated_clock -name {ADC_Pot_intClock} -source [get_pins {ClockBlock/hfclk}] -edges {1 41 81} [list]
