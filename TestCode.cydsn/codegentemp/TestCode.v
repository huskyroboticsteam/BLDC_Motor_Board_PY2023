...
module top ;
    ...
    assign Net_116 = ~Net_270;


    assign Net_117 = ~Net_272;
	...
	cy_psoc3_pins_v1_10
		#(.id("86a90bbb-e3b1-4d37-8817-474bbb81f22f"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("df3ba5e7-28f6-4e51-b4f7-2438aee561e8"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5c2ed3f6-39d4-4fc3-91b0-b03cf0c55def"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
